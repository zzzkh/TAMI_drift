...
if __name__ == "__main__":
    ...
    if args.model_name == 'EdgeBank':
        ...
        for run in range(args.num_runs):
            ...
            args.save_result_name = f'NotloadTRC_{args.not_load_trc_memory}_{args.negative_sample_strategy}_gamma_{args.gamma}_{args.model_name}_seed{args.seed}'
            ...
            link_predictor = HistoricalDecoder(input_dim1=node_raw_features.shape[1], input_dim2=node_raw_features.shape[1],
                                    hidden_dim=node_raw_features.shape[1], output_dim=1, device=args.device, gamma=args.gamma)
            ...
            early_stopping = EarlyStopping(patience=0, save_model_folder=load_model_folder,
                                           ...
                                           not_load_trc_memory=args.not_load_trc_memory)
            ...
            if args.model_name not in ['JODIE', 'DyRep', 'TGN']:
                val_losses, val_metrics = evaluate_model_link_prediction(model_name=args.model_name,
                                                                         ...
                                                                         number_of_negative_edges=args.num_neg_edges)
